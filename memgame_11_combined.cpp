...
void wrong_cards(/*std::vector<bool> cardFlipped,*/sf::RenderWindow& window,vector<string> questions_answers){
    //temporarily displays wrong cards
       for (int i = 0; i < 16; i++) {
             //if (cardFlipped[i]) {
                    window.draw(questions_answers[i]);
            //}
        } 
                                ...
                                if (!cardFlipped[i]) {
                                    if (hasFlippedCard) {
                                        ...
                                        if (questions_answers[i] == questions_answers[flippedCardIndex]) {
                                            ...
                                            wrong_cards(window,questions_answers_text);
                                        }
