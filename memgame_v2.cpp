...
void randomizecards(sf::RenderWindow& window, string one, string two, string three, string four, string five, string six, string seven, string eight,
string ansone, string anstwo, string ansthree, string ansfour, string ansfive, string anssix, string ansseven, string anseight){
    sf::Text flipcard;
    sf::Font font;
    font.loadFromFile("/System/Library/Fonts/Supplemental/Arial.ttf");
    flipcard.setFont(font);
    
    flipcard.setString(one); //string would be actual question
    ...
    flipcard.setString(two); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(three); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(four); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(five); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(six); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(seven); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(eight); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(ansone); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(anstwo); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(ansthree); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(ansfour); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(ansfive); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(anssix); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(ansseven); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);

    flipcard.setString(anseight); //string would be actual question
    flipcard.setFillColor(sf::Color::White);
    flipcard.setOutlineThickness(1);
    flipcard.setPosition(150,100);
    flipcard.setCharacterSize(50);
